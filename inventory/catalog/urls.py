...
urlpatterns = [
   ...
   url(r'^item/(?P<pk>[0-9]+)/update/$', views.UpdateItemView.as_view(), name="itemupdate"),
   url(r'^item/(?P<pk>[0-9]+)/updatequantity/$', views.UpdateItemQuantityView.as_view(), name="itemupdatequantity"),
